      ...
      module CRDB
        module V1alpha1
          class CrdbCluster < ::KubeDSL::DSLObject
            ...
            T::Sig::WithoutRuntime.sig { returns(Kuby::CRDB::DSL::CRDB::V1alpha1::CrdbClusterStatus) }
            def status; end
            ...
            T::Sig::WithoutRuntime.sig { returns(Kuby::CRDB::DSL::CRDB::V1alpha1::CrdbClusterSpec) }
            def spec; end
